    ...
    <footer className="bg-navy-900 text-slate-400">
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
          <div className="md:col-span-2">
            ...
            <p className="text-sm leading-relaxed max-w-sm">
              An Educational Intelligence Platform for Dutch professional education.
              Connecting curriculum, teaching, assessment and student success.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-sm">
              <Link to="/why-sapiion" className="hover:text-white transition-colors">Why Sapiion</Link>
              <Link to="/solutions" className="hover:text-white transition-colors">Solutions</Link>
              <Link to="/demo" className="hover:text-white transition-colors">Request a demo</Link>
            </div>
          </div>
        ...
        <div className="border-t border-navy-700 pt-6 flex flex-col md:flex-row justify-between items-center gap-3 text-xs">
          <p>© {new Date().getFullYear()} Noor B.V. — All rights reserved.</p>
